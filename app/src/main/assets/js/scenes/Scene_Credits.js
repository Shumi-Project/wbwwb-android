...
function Scene_Credits() {
    ...
    // add text
    var createdByText = new PIXI.Text(textStrings["createdBy"], { fontFamily: "Times", fontSize: 46, fill: "#FFFFFF", align: "left" });
    ...
    var authorText = new PIXI.Text(textStrings["NickyCase"], { fontFamily: "Times", fontSize: 86, fill: "#FFFFFF", align: "left" });
    ...
    var portBy = new PIXI.Text(textStrings["androidPortBy"], { fontFamily: "Times", fontSize: 46, fill: "#FFFFFF", align: "left" });
    portBy.anchor.x = 0.0;
    portBy.anchor.y = 0.5;
    ...
    var aozora = new PIXI.Text(textStrings["AozoraDev"], { fontFamily: "Times", fontSize: 86, fill: "#FFFFFF", align: "left" });
    aozora.anchor.x = 0.0;
    aozora.anchor.y = 0.5;
    ...
    var playtestersText = new PIXI.Text(textStrings["manyThanks"], { fontFamily: "Times", fontSize: 44, fill: "#FFFFFF", align: "right" });
    ...
    var supportersText1 = new PIXI.Text(textStrings["patreonSupporters"], { fontFamily: "Times", fontSize: 45, fill:"#FFFFFF", align: "left" });
    ...
    var supportersText2 = new PIXI.Text(textStrings["patreonSupporters"], { fontFamily: "Times", fontSize: 45, fill:"#FFFFFF", align: "left" });
    ...
    var supportersText3 = new PIXI.Text(textStrings["patreonSupporters"], { fontFamily: "Times", fontSize: 45, fill:"#FFFFFF", align: "left" });
    ...
    var supportersText4 = new PIXI.Text(textStrings["patreonSupporters"], { fontFamily: "Times", fontSize: 45, fill:"#FFFFFF", align: "left" });
    ...
    var thankYouText = new PIXI.Text(textStrings["thankYouForPlaying"], { fontFamily: "Times", fontSize: 55, fill: "#FFFFFF", align: "center" });
    ...
    var finallyText = new PIXI.Text(textStrings["lastButNotLeast"], { fontFamily: "Times", fontSize: 37, fill: "#FFFFFF", align: "left" });
